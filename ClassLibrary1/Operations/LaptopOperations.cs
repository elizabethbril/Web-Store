...
namespace Logic
{
    public class LaptopOperations
    {
        ...
        public void AddLaptop(Laptop Laptop)
        {
            ...
            _uow.Laptops.Create(new Database.Laptop { Name = Laptop.Name, Description = Laptop.Description, Price = Laptop.Price, imageLink = Laptop.ImageLink, Views = Laptop.Purchases });
